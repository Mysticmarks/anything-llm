...
async function streamChatWithWorkspace(
  ...
  const span = LatencyProfiler.startSpan("chat.stream", {
  ...
  try {
      if (Object.keys(VALID_COMMANDS).includes(updatedMessage)) {
        ...
        finish({ status: "command", command: updatedMessage });
        return;
      }
    ...
    // we do regular waiting of a response and send a single chunk.
      ...
      const metadata = {
        ...
        streaming: LLMConnector.streamingEnabled() === true,
      };
